...
$router->group(function () use ($router) {
    ...
    $router->get('modules', '\catchAdmin\system\controller\OperateLog@modules');
    ...
    $router->get('config/basic', '\catchAdmin\system\controller\Config@basic');
    $router->get('config/contact', '\catchAdmin\system\controller\Config@contact');
